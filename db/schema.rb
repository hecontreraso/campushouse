...
ActiveRecord::Schema.define(version: 20151226044311) do
  ...
  create_table "lolencios", force: :cascade do |t|
  ...
  add_index "lolencios", ["email"], name: "index_lolencios_on_email", unique: true, using: :btree
  add_index "lolencios", ["reset_password_token"], name: "index_lolencios_on_reset_password_token", unique: true, using: :btree

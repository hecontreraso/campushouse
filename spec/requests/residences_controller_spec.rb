...
RSpec.describe ResidencesController, type: :controller do
  ...
  #       post :create, {:residence => invalid_attributes}, valid_session
  #       expect(assigns(:residence)).to be_a_new(Residence)
  #     end
  ...
  #       residence = Residence.create! valid_attributes
  #       put :update, {:id => residence.to_param, :residence => new_attributes}, valid_session
  #       residence.reload
  ...
  #       residence = Residence.create! valid_attributes
  #       put :update, {:id => residence.to_param, :residence => invalid_attributes}, valid_session
  #       expect(assigns(:residence)).to eq(residence)
  #     end
